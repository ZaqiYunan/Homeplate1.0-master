                     ...
                     <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                        ...
                        <DialogContent>
                            <DialogHeader>
                                ...
                                <DialogDescription>
                                    Provide your details to get personalized daily nutritional recommendations from our AI. Age and gender help improve accuracy but are optional.
                                </DialogDescription>
                            </DialogHeader>
                            <Form {...form}>
                                <form onSubmit={form.handleSubmit(onPersonalizeSubmit)} className="space-y-4">
                                    ...
                                    <FormField
                                        ...
                                        <FormItem>
                                            ...
                                            <FormDescription className="text-xs">
                                                Helps calculate more accurate calorie needs
                                            </FormDescription>
                                            <FormMessage />
                                        </FormItem>
                                        )}
                                    ...
                                    <FormField
                                        ...
                                        <FormItem>
                                            ...
                                            <FormDescription className="text-xs">
                                                Helps calculate metabolic rate differences
                                            </FormDescription>
                                            <FormMessage />
                                        </FormItem>
                                        )}
