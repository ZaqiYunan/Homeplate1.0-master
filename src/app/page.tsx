...
export default function SupabaseLandingPage() {
  return (
    <AppProvider>
      ...
      {/* Main content area */}
      <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-8 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
