...
import { ChefHat, Warehouse, LogIn, LogOut, UserPlus, UserCircle2, LayoutDashboard, HeartPulse, Shield, Leaf } from 'lucide-react';
...
export function SupabaseHeader() {
  ...
  const navItems = [
    ...
    { href: '/ingredients', label: 'Ingredients', icon: <Leaf size={18} />, protected: true },
